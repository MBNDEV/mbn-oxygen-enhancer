(async function() {
    ...
    // load fonts when window is loaded
    window.addEventListener('load', function() {
        var delayassets = document.querySelectorAll('link[data-mbn-delayed="true"]');
        delayassets.forEach(function(delayasset) {
            var href = delayasset.getAttribute('data-href');
            delayasset.href = href;
        });
    });
})();
